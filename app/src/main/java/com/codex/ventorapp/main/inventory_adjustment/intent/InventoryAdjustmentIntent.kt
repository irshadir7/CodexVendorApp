...
sealed class InventoryAdjustmentIntent {
    ...
    class GetUpdateInventory(val token: String,val product_id: String,val location_id: String,val stock_quant_id: String,val inventory_quantity: String) : InventoryAdjustmentIntent()
}